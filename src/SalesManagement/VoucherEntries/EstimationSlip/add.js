  ...
  return (
    <div className='w-full'>
        ...
        <div className='px-8 py-6'>
          ...
          <div className='pb-2'>
            ...
            <input
              ...
              value={estimationSlip["estimation_date"]}
          ...
          <div className='pb-2'>
            ...
            <input
              ...
              value={estimationSlip["estimation_due_date"]}
              onChange={handleChange}
            />
          ...
          <div className='pb-2'>
            ...
            <input
              ...
              value={estimationSlip["estimated_delivery_date"]}
              onChange={handleChange}
            />
          </div>
          ...
          <div className='pb-2'>
            ...
            <input
              ...
              placeholder='適用開始日を入力'
              name="closing_date"
              value={estimationSlip["closing_date"]}
              onChange={handleChange}
            />
          </div>
          ...
          <div className='pb-2'>
            ...
            <input
              ...
              placeholder='適用開始日を入力'
              name="deposit_due_date"
              value={estimationSlip["deposit_due_date"]}
              onChange={handleChange}
            />
          </div>
      ...
      <div className='flex mt-8 fixed bottom-0 border-t w-full py-4 px-8 bg-white'>
        ...
        <Link to={`salesmanagements/estimation-slip`} className='border rounded px-4 py-3 font-bold cursor-pointer'>キャンセル</Link>
      </div>
    </div>
  );
}

export default EstimationSlipAdd;
