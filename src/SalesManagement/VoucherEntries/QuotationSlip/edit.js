    ...
    return (
        <div className='w-full'>
            ...
            <div className='flex mt-8 fixed bottom-0 border-t w-full py-4 px-8 bg-white'>
                ...
                <Link to={`sales-managements/quotation-slip`} className='border rounded px-4 py-3 font-bold cursor-pointer'>キャンセル</Link>
            </div>
        </div>
    );
}
...
export default QuotationSlipEdit;
