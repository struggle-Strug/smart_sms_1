                ...
                <div className='px-8 py-6'>
                    ...
                    <div className='flex items-center'>
                        ...
                        <div className=''>
                            <div className='flex items-center'>
                                <div className=''>
                                    <div className='text-sm pb-1.5'>入金伝票番号 <span className='text-xs ml-2.5 font-bold text-red-600'>必須</span></div>
                                    <input type='text' className='border rounded px-4 py-2.5 bg-white' placeholder='' name="" value={""} style={{ width: "120px" }} />
                                </div>
                                <div className='ml-4'>
                                    <div className='text-sm pb-1.5'>入金日付 <span className='text-xs ml-2.5 font-bold text-red-600'>必須</span></div>
                                ...
                                <div className='ml-4'>
                                    <div className='text-sm pb-1.5'>入金方法 <span className='text-xs ml-2.5 font-bold text-red-600'>必須</span></div>
                                    <input type='text' className='border rounded px-4 py-2.5 bg-white' placeholder='' name="" value={""} style={{ width: "120px" }} />
                                </div>
                                <div className='ml-4'>
                                    <div className='text-sm pb-1.5'>入金額 <span className='text-xs ml-2.5 font-bold text-red-600'>必須</span></div>
                                    <input type='text' className='border rounded px-4 py-2.5 bg-white' placeholder='' name="" value={""} style={{ width: "120px" }} />
                                </div>
                            </div>
