        ...
        <div className='w-full'>
            <div className='p-8'>
                ...
                <table className="w-full mt-8 ">
                    <thead className=''>
                        <tr className=''>
                            <th className='text-left'>得意先名1</th>
                            <th className='text-left'>得意先名2</th>
                            <th className='text-left'>得意先コード</th>
                        ...
                        {customers.map((customer) => (
                            <tr className='border-b' key={customer.id}>
                                ...
                                <td className='flex justify-center relative'>
                                    {isOpen && <DropDown id={customer.id} />}
                                    <div className='border rounded px-4 py-3' onClick={toggleDropdown}>
