                ...
                <table className="w-full mt-8 ">
                    <thead className=''>
                        <tr className=''>
                            ...
                            <th className='text-left'>商品分類1</th>
                            <th className='text-left'>JANコード</th>
                            <th className='text-left'>標準売価</th>
                    ...
                    <tbody>
                        {products.map((product) => (
                            <tr className='border-b' key={product.id}>
                                <td>{product.name}</td>
                                <td>{product.classification_primary}</td>
                                <td>{product.jan_code}</td>
                                <td>{product.standard_retail_price}</td>
                                <td className='flex justify-center relative'>
                                    {isOpen === product.id && <DropDown id={product.id} />}
                                    <div className='border rounded px-4 py-3' onClick={(e) => toggleDropdown(product.id)}>
