    ...
    <div className='w-full'>
      <div className='p-8'>
        <div className=' mb-8 flex'>
          <div className='text-2xl font-bold'>{facility.name || '倉庫詳細'}</div>
          <Link to={`/master/storage-facilities/edit/${facility.id}`} className='ml-auto py-3 px-4 border rounded-lg text-base font-bold'>編集する</Link>
        </div>
