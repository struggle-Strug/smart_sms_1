        ...
        <div className='w-full'>
            <div className='p-8'>
                ...
                <table className="w-full mt-8 ">
                    <thead className=''>
                        <tr className=''>
                            <th className='text-left'>顧客名1</th>
                            <th className='text-left'>顧客名2</th>
                            <th className='text-left'>取引先コード</th>
                    ...
                    <tbody>
                        {deliveryCustomers.map((customer) => (
                            <tr className='border-b' key={customer.id}>
                                <td>{customer.name_primary}</td>
                                <td>{customer.name_secondary}</td>
                                <td>{customer.billing_code}</td>
                                <td>{customer.phone_number}</td>
                                <td>{customer.email}</td>
                                <td className='flex justify-center relative'>
                                    {isOpen === customer.id && <DropDown id={customer.id} />}
                                    <div className='border rounded px-4 py-3' onClick={(e) => toggleDropdown(customer.id)}>
