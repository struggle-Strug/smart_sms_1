    ...
    <div className='w-full'>
      <div className='p-8'>
        <div className=' mb-8 flex'>
          <div className='text-2xl font-bold'>{customer.name_primary || '納品先詳細'}</div>
          <Link to={`/master/delivery-customers/edit/${customer.id}`} className='ml-auto py-3 px-4 border rounded-lg text-base font-bold'>編集する</Link>
        </div>
        ...
        <div className="flex bg-white">
          <div className="w-1/5">
            <div className='p-4'>納品先目1(カタカナ) </div>
          </div>
          <div className="w-4/5 py-1.5">
