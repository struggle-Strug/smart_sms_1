...
function DeliveryCustomersEdit() {
    ...
    useEffect(() => {
        // 初期ロード時に顧客データを取得
        ipcRenderer.send('edit-delivery-customer', id);
        ipcRenderer.on('edit-delivery-customer', (event, customerData) => {
            setDeliveryCustomer(customerData);
        });
        ...
        return () => {
            ...
            ipcRenderer.removeAllListeners('edit-delivery-customer');
        };
    }, [id]);
    ...
    return (
        <div className='w-full'>
            <div className='p-8'>
                <div className='text-2xl font-bold mb-8'>{deliveryCustomer.name_primary}</div>
...
export default DeliveryCustomersEdit;
