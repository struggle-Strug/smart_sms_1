...
function Home() {
  ...
  const messageDetail = [
    {
      date: "2024-10-10",
      content: "在庫補充アラート: 商品A（予定）"
    },
    {
      date: "2024-10-10",
      content: "在庫補充アラート: 商品B（緊急）"
    },
    {
      date: "2024-10-10", 
      content: "在庫補充アラート: 商品C（緊急）"
    },
    {
      date: "2024-10-10",
      content: "在庫が不足しています。ただちに商品を補充してください。"
    },
  ];
    ...
    <>
      {
        ...
        <div className='mx-40 my-9'>
          <>
            ...
            <div className='p-6 rounded-xl'>
              ...
              {messageDetail.length === 0 ? (
                ...
                messageDetail.map((message, index) => (
                  <div key={index} className='grid grid-cols-12 mb-4'>
            ...
            <div className=''>
              <div className='flex items-center'>
                <Link to="dashboards/admin-settings" className='flex items-center py-3 px-4 border rounded ml-14'>
