...
function PurchaseInvoicesAdd() {
  ...
  const handleSubmit = () => {
    setErrors(null);
    validator.required(purchaseInvoice.code, 'code', '伝票番号');
        ...
        <div className='px-8 py-6'>
          ...
          <div className='pb-2'>
            ...
            <input
              ...
              name="order_date"
              value={purchaseInvoice.order_date}
          ...
          <div className='pb-2'>
            ...
            <input
              ...
              placeholder='適用終了日を入力'
              name="closing_date"
              value={purchaseInvoice.closing_date}
              onChange={handleChange}
            />
          ...
          <div className='pb-2'>
            ...
            <input
              ...
              value={purchaseInvoice.payment_due_date}
              onChange={handleChange}
            />
