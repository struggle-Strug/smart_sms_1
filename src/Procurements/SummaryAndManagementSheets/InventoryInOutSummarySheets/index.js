...
function Index() {
    ...
    return (
        <div className='w-5/6'>
            <div className='p-8'>
                <div className='pb-6 text-2xl font-bold'>入出庫集計表</div>
                <div className='bg-gray-100 rounded p-6'>
                    ...
                    <div className='grid grid-cols-3 gap-8'>
                        ...
                        <div>
                            ...
                            <input type='text' className='border rounded px-4 py-2.5 bg-white w-full' placeholder='' name="processType" value={searchQueryList["siod.processType"]} onChange={handleInputChange} />
                        </div>
                        <div>
